...
function Login() {
    ...
    return (
        <div className="form">
            <Typography variant="h4"><b>PubConnect</b></Typography>
            ...
            <div id="username_group">
                ...
                <br />
                <Link className="login_button" to={{ pathname: "/home", userInfo: [usernames, email] }} > <Button variant="outlined" color="primary">Start Survey</Button></Link>
            </div>
            <p>* Your email address will not be shared beyond the members of the group conducting the survey (i.e., Ilya Baldin, Paul Ruth, Brittany Todd, Bo Zhou, and Laura Christopherson at RENCI, UNC-Chapel Hill). We are asking for it
            ...
            and to contact you if you win the raffles.
                No other personal information about you will be asked in the course of this survey.</p>
        </div >
    )
}
